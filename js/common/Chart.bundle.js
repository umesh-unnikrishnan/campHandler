		...
		draw: function(chartArea) {
			...
			if (isHorizontal) {
				...
				if (maxTicks && me.ticks.length > maxTicks) {
                    ...
                    if(me.ticks.length % skipRatio !=0 && me.ticks.length>40){
                        secondLastSkipRatio = Math.floor((me.ticks.length - skipRatio*((me.ticks.length/skipRatio)-2))/2);
                    }
				}
			...
			helpers.each(me.ticks, function(label, index) {
				...
				var shouldSkip = (((skipRatio > 1 && index % skipRatio > 0) || (index % skipRatio === 0 && index + skipRatio >= me.ticks.length && me.ticks.length % skipRatio !=0)) && (index + secondLastSkipRatio!=me.ticks.length));
